...
ifeq ($(TARGET_ARCH_ABI),armeabi-v7a)
    ...
    FFMPEG_INCLUDE_PATH := $(LOCAL_PATH)/ffmpeg/android/arm64-v8a/include
    LOCAL_SRC_FILES := ./ffmpeg/android/arm64-v8a/lib/libavutil.a
else ifeq ($(TARGET_ARCH_ABI),x86)
    FFMPEG_INCLUDE_PATH := $(LOCAL_PATH)/ffmpeg/android/i686/include
    LOCAL_SRC_FILES := ./ffmpeg/android/i686/lib/libavutil.a
else ifeq ($(TARGET_ARCH_ABI),x86_64)
    FFMPEG_INCLUDE_PATH := $(LOCAL_PATH)/ffmpeg/android/x86_64/include
    LOCAL_SRC_FILES := ./ffmpeg/android/x86_64/lib/libavutil.a
endif
...
ifeq ($(TARGET_ARCH_ABI),armeabi-v7a)
    ...
    LOCAL_SRC_FILES := ./ffmpeg/android/arm64-v8a/lib/libavformat.a
else ifeq ($(TARGET_ARCH_ABI),x86)
    LOCAL_SRC_FILES := ./ffmpeg/android/i686/lib/libavformat.a
else ifeq ($(TARGET_ARCH_ABI),x86_64)
    LOCAL_SRC_FILES := ./ffmpeg/android/x86_64/lib/libavformat.a
endif
...
ifeq ($(TARGET_ARCH_ABI),armeabi-v7a)
    ...
    LOCAL_SRC_FILES := ./ffmpeg/android/arm64-v8a/lib/libavcodec.a
else ifeq ($(TARGET_ARCH_ABI),x86)
    LOCAL_SRC_FILES := ./ffmpeg/android/i686/lib/libavcodec.a
else ifeq ($(TARGET_ARCH_ABI),x86_64)
    LOCAL_SRC_FILES := ./ffmpeg/android/x86_64/lib/libavcodec.a
endif
...
ifeq ($(TARGET_ARCH_ABI),armeabi-v7a)
    LOCAL_SRC_FILES := ./ffmpeg/android/armv7-a/lib/libavresample.a
else ifeq ($(TARGET_ARCH_ABI),arm64-v8a)
    LOCAL_SRC_FILES := ./ffmpeg/android/arm64-v8a/lib/libavresample.a
else ifeq ($(TARGET_ARCH_ABI),x86)
    LOCAL_SRC_FILES := ./ffmpeg/android/i686/lib/libavresample.a
else ifeq ($(TARGET_ARCH_ABI),x86_64)
    LOCAL_SRC_FILES := ./ffmpeg/android/x86_64/lib/libavresample.a
endif
...
ifeq ($(TARGET_ARCH_ABI),armeabi-v7a)
    ...
    LOCAL_SRC_FILES := ./ffmpeg/android/arm64-v8a/lib/libswresample.a
else ifeq ($(TARGET_ARCH_ABI),x86)
    LOCAL_SRC_FILES := ./ffmpeg/android/i686/lib/libswresample.a
else ifeq ($(TARGET_ARCH_ABI),x86_64)
    LOCAL_SRC_FILES := ./ffmpeg/android/x86_64/lib/libswresample.a
endif
